          ...
          <Header>
            ...
            <div style={{ 
              ...
              >
                ...
                <option value="qwen3-0.6b">Qwen3 0.6B (0.36GB)</option>
                <option value="qwen3-1.7b">Qwen3 1.7B (0.8GB)</option>
                <option value="qwen3-4b">Qwen3 4B (1.7GB)</option>
                <option value="qwen3-8b">Qwen3 8B (3.5GB)</option>
