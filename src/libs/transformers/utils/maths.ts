...
export function interpolate_data(input: TypedArray, [in_channels, in_height, in_width]: [number, number, number], [out_height, out_width]: [number, number], mode = 'bilinear', align_corners = false) {
