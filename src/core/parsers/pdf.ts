...
export class PDFParser {
  ...
  private static async extractTextFromPdf(
    ...
    const { maxPages = pdf.numPages, includePageNumbers = false, pageSeparator = '\n\n' } = options;
 ...
 * @returns Promise resolving to the parsed PDF content
 */
export async function extractTextFromPdf(source: string | ArrayBuffer, options: PDFParseOptions = {}): Promise<string> {
